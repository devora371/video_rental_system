...
namespace VideoRentalSystem
{
    ...
    {
        private static SqlConnection myCon = new SqlConnection("Data Source=DESKTOP-7Q26D3G\\SQLEXPRESS;Initial Catalog=VideoRentalDB;Integrated Security=True");
        static SqlCommand myCmd;
        public static void ViewCustomer(DataGridView gv)
        {
            SqlDataAdapter da = new SqlDataAdapter("viewCustomer", myCon);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
            DataTable dataTable = new DataTable();
            da.Fill(dataTable);
            gv.DataSource = dataTable;
        }
        public static void ViewVideo(DataGridView gv)
        {
            SqlDataAdapter da = new SqlDataAdapter("viewVideo", myCon);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
            DataTable dataTable = new DataTable();
            da.Fill(dataTable);
            gv.DataSource = dataTable;
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("viewBooking", myCon);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
            DataTable dataTable = new DataTable();
            da.Fill(dataTable);
            gv.DataSource = dataTable;
        ...
        public static void Delete(TextBox a, TextBox b, TextBox c,DateTimePicker d, string id)
        {
        ...
        public static void Add(TextBox a, TextBox b, TextBox c,DateTimePicker d)
        {
        ...
        public static void Add(Button a, Button b, DateTimePicker c, DateTimePicker d)
        {
            int count = 0;
            ...
            if (count != 0)
            {
                string query = "insert into Booking(CID,VID,Start,Due,Status,Cost) values(" + Convert.ToInt32(a.Tag) + "," + Convert.ToInt32(b.Tag) + ",'" + c.Value.ToString("dd MMMM yy") + "','" + d.Value.ToString("dd MMMM yy") + "','Issue',0); update Video set Copies=Copies-1 where ID=" + Convert.ToInt32(b.Tag) + "; ";
                try
                {
                    myCon.Open();
                    myCmd = new SqlCommand(query, myCon);
        ...
        public static void Update(TextBox a, TextBox b, TextBox c,DateTimePicker d, string id)
        {
        ...
        public static void Update(Button a, Button b, DateTimePicker c, DateTimePicker d, String id, int i)
        {
            string query = "update Booking set CID=" + Convert.ToInt32(a.Tag) + ", VID=" + Convert.ToInt32(b.Tag) + ", Start='" + c.Value.ToString("dd MMMM yy") + "',Due='" + d.Value.ToString("dd MMMM yy") + "', Cost="+i+"  ,Status='Return' where ID=" + Convert.ToInt32(id) + "; update Video set Copies=Copies+1 where ID=" + b.Tag + "; ";
            try
            {
                myCon.Open();
                myCmd = new SqlCommand(query, myCon);
        ...
        public static void loadStat(Label a, Label b, Label c, Label d,Label e)
        {
            ...
            string query4 = "select sum(Cost) from Booking;";
